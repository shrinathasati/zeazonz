...
const TimelineChart = () => {
  ...
  const handlePreviousButton = () => {
    const newStart = dayjs(visibleTimeStart)
      .subtract(1, currentView === "month" ? "month" : "week")
      .startOf(currentView === "month" ? "month" : "week");
    const newEnd = newStart.add(
      currentView === "month" ? 1 : 4,
  ...
  const handleNextButton = () => {
    const newStart = dayjs(visibleTimeStart)
      .add(1, currentView === "month" ? "month" : "week")
      .startOf(currentView === "month" ? "month" : "week");
    const newEnd = newStart.add(
      currentView === "month" ? 1 : 4,
      currentView === "month" ? "month" : "week"
